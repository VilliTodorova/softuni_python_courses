...
class Tests(unittest.TestCase):
    ...
    def test_zoo_tend_animal_success(self):
        ...
        self.assertEqual(res, "You tended all the ex_05_animals. They are happy. Budget left: 205")
    ...
    def test_zoo_tend_animal_no_budget(self):
        ...
        z.add_animal(Tiger("Bill", "f", 4), 100)
        res = z.tend_animals()
        self.assertEqual(res, "You have no budget to tend the ex_05_animals. They are unhappy.")
