...
class ManagingApp:
    ...
    def upload_vehicle(self, vehicle_type: str, brand: str, model: str, license_plate_number: str):
        ...
        v = self.VALID_VEHICLES[vehicle_type](brand, model, license_plate_number)
    ...
    def allow_route(self, start_point: str, end_point: str, length: float):
        ...
        r = Route(start_point, end_point, length, index)
    ...
    def repair_vehicles(self, count: int):
        ...
        sorted_damaged_vehicles = sorted(damaged_vehicles, key=lambda vehicle: (vehicle.brand, vehicle.model))[:count]
